...
const DashboardPrograms = () => {
  ...
  return (
    <Layout>
      ...
      {/* <div className="flex justify-center px-12 lg:px-28 w-full"> */}

      {/* For Rabelais */}
      {/* grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4 border-b pb-10 */}

      {/* Mine */}
      {/* flex flex-wrap py-8 px-12 lg:px-28 gap-[30px] overflow-y-scroll w-auto */}
        <div className="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4 border-b pb-10 px-12 lg:px-28">
