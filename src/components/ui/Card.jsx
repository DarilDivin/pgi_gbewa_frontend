...
const Card = ({title, number, active, link, children}) => {
  return (
      <a 
        ...
        className={
          active ? 
          'lg:w-72 h-28 group bg-green-700 hover:bg-green-800 rounded-lg grid grid-cols-[100px_1fr] justify-between items-center p-4 shadow-xl xl:justify-self-center xl:first:justify-self-start xl:last:justify-self-end' : 
          `lg:w-72 h-28 group bg-slate-100 hover:bg-green-700 rounded-lg grid grid-cols-[100px_1fr] justify-between items-center p-4 shadow-lg xl:justify-self-center xl:first:justify-self-start xl:last:justify-self-end`
        }
      >
